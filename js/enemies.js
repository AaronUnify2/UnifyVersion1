...
const enemyTypes = [
    { name: 'slime', texture: createSlimeTexture, scale: [2.5, 2.5], speed: 0.025, healthMult: 0.5, damageMult: 0.5, xp: 10, gold: 20, goldChance: 0.1 },
    ...
    { name: 'bat', texture: createBatTexture, scale: [3, 2], speed: 0.17, healthMult: 0.4, damageMult: 1.6, xp: 90, gold: 1000, goldChance: 0.01 },
    { name: 'wizard', texture: createWizardTexture, scale: [2.5, 4], speed: 0.028, healthMult: 5.0, damageMult: 3.4, xp: 150, gold: 90, goldChance: 0.75 }
];
