...
const enemyTypes = [
    { name: 'slime', texture: createSlimeTexture, scale: [2.5, 2.5], speed: 0.025, healthMult: 0.5, damageMult: 0.5, xp: 1000, gold: 1000, goldChance: 0.95 },
    ...
    { name: 'bat', texture: createBatTexture, scale: [3, 2], speed: 0.17, healthMult: 0.4, damageMult: 1.6, xp: 10000, gold: 3, goldChance: 0.95 },
